  ...
  >
    <div class="text-white md:mx-4 sm:mx-16 space-y-8">
      ...
      <div class="flex flex-col sm:flex-row gap-6 justify-center sm:justify-start">
        <button
          class="swimButton duration-300 relative group cursor-pointer text-sky-50 overflow-hidden h-12 w-64 rounded-md bg-sky-200 p-2 flex justify-center items-center font-medium"
        >
          <div
